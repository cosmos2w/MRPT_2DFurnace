...
from network import CoFFe_PreTrain_Net_MutualDecodingMode
...
outFile = f'data_split/CoFFe_MutualDecoding_Features_From{field_idx}_{N_selected}.pic'
...
if __name__ == '__main__':
    ...
    for id in range(len(field_names) + 1):
        ...
        with open(f'LatentRepresentation/MutualDecodingMode/FeaturesFrom_{PreTrained_Net_Name}_To_{field_name_or_feature}.csv', 'wt') as fp: 
            pass
    ...
    with torch.no_grad():
        for U, Y, G, Yin, Gin in get_data_iter(U_train, Y_train, G_train, Yin_train, Gin_train):
            ...
            if EVALUATION is True:
                ...
                field_loss_data, field_losses = custom_mse_loss(Unified_Gout_train, G, field_weights)
        ...
        for U, Y, G, Yin, Gin in get_data_iter(U_test, Y_test, G_test, Yin_test, Gin_test):
            ...
            if EVALUATION is True:
                ...
                field_loss_data, field_losses = custom_mse_loss(Unified_Gout_test, G, field_weights)
