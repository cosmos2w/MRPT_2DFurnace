...
NET_NAME = [f'MRPT_SensorToFeature_N{N_selected}_Noise3', f'Direct_SensorToFeature_N{N_selected}_Noise5']
...
if __name__ == '__main__':
    ...
    with open('data_split/data_split_Multi_{}.pic'.format(Case_Num), 'rb') as fp: 
        ...
        indices_path = 'indices/Y_select_indices_{}.pkl'.format(Case_Num)
